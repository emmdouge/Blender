...
ffmpeg -i %1_3sframes\testp1.mp4 -vf negate %1_output3s.mp4 
...
ffmpeg -i %1_4sframes\testp1.mp4 -vf negate %1_output4s.mp4 
...
ffmpeg -i %1_6sframes\testp1.mp4 -vf negate %1_output6s.mp4 
...
ffmpeg -stream_loop 8 -i %1_output.mp4 -c copy %1_output_loop.mp4