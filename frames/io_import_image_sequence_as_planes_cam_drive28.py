...
class IMPORT_OT_image_to_plane(Operator, AddObjectHelper):
	...
	match_len = BoolProperty(name="Match Movie Length", default=False, description=t.description)

	#t = bpy.types.Image.bl_rna.properties["use_fields"]
	use_fields = BoolProperty(name="Fields", default=False, description=t.description)

	#t = bpy.types.ImageUser.bl_rna.properties["use_auto_refresh"]
	use_auto_refresh = BoolProperty(name="Auto Refrseh", default=True, description=t.description)
